...
public class LocationUpdatesService extends Service implements GoogleApiClient.ConnectionCallbacks,
    ...
    private Notification getNotification() {
        ...
        return new NotificationCompat.Builder(this)
                .addAction(R.drawable.ic_cast_dark, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.cast_ic_notification_small_icon, getString(R.string.remove_location_updates),
